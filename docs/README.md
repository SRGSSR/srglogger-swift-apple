...
The library is suitable for applications running on iOS 9, tvOS 9, watch OS 3 and above. The project is meant to be opened with the latest Xcode version (currently Xcode 10) and built with the Swift 5 compiler.
...
```
github "SRGSSR/srglogger-swift-ios"
```
